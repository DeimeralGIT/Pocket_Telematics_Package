...
class PocketTelematics {
  Future<bool> requestService() async => Permission.locationWhenInUse.request().then((locWhenInUse) {
        Permission.locationAlways.request().then((locAlways) {
          Permission.ignoreBatteryOptimizations.request().then((batteryOptimisation) {
            ...
            return locWhenInUse.isGranted && locAlways.isGranted && batteryOptimisation.isGranted;
          });
        });
      });
